...
Each node $v$ can be uniquely identified by its \emph{cluster} $C$, which is the set of taxa descending from the node. \todo{move cluster+mrca to alg:find\_path}
