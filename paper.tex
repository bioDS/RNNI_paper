...
\title{Geometry of Ranked Nearest Neighbour Interchange Space of Phylogenetic Trees}
\date{\today}
...
In the terminology of \autocite{Gavryushkin2018-ol}, the space considered in this paper is $\rnniu$ (see the Section~\ref{sex:...} for accurate definitions).

[Figure of ranked tree]

In line with the research programme proposed in \autocite{Gavryushkin2018-ol}, we investigate the geometry of the $\rnni$ space and also consider several computational versions of the problems.
...
A \emph{ranked phylogenetic tree} is a pair consisting of a rooted binary phylogenetic tree $T$ on the set $X = \{1, \ldots, n\}$ of taxa for $n \in \mathbb N$, and a rank function that maps $X$ to $0$, all internal nodes to $\{1, \ldots, n-1\}$, and respects the partial order given by the tree.
