...
\address{\textsuperscript{1}Department of Mathematics and Statistics, University of Otago, New Zealand}
...
Considered with the metric given by the length of the shortest path, this graph becomes a metric space and its geometry has been extensively studied \autocite{...}.
...
[say a bit about tree search and sampling algorithms -- they are hard too]

[a paragraph on RNNI, mention that only ultrametric trees considered (extension could be mentioned in the end)]

[Figure of ranked tree]

[summary of results, including the approaximate algorithm that works exactly on small spaces (Lena: is it already in the text?)]
