...
The proof presented in~\cite{Li1996} for Theorem~\ref{thm:split_nni} does not work for $\rnni$. \todo{because?}
...
% This can be computationally proven for up to $8$ taxa.
