...
\todo{define splits and delete definition from split thm chapter!}
\todo{change definition of clusters: induced by vertices, not edges!}
...
The clusters given by the two edges incident to the root are $\{1, \ldots, n\}$ and $\{n+1, \ldots, 2n\}$ in both trees $T$ and $R$.
