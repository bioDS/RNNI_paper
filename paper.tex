...
However, we don't know how good Algorithm~\ref{alg:find_path} distances in $\rnni$.
...
Moreover, we can conclude from Lemma~\ref{lemma:caterpillar_diameter} that the maximum distance computed by Algorithm~\ref{alg:find_path} equals the diameter of $\rnni$.
This quality of the algorithm suggests that it gives reasonable estimates of distances.
