...
The following lemma shows that $\findpath$ gives a path between the two input trees, indeed, by proving that there is always an $\rnni$ move possible as descibred in Line~\ref{ald:findpath:line:move_set_down} of Algorithm~\ref{alg:find_path}.
...
\begin{proof}
    ...
    \todo{LC: From here on it is confusing}
