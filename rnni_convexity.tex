...
\proof
It is suffice to show that the update operation (line~\ref{alg:findpath:line:move_set_down}) is well-defined, that is the $\rnni$ move that decreases the rank of $\mrca_{T'}(C_k)$ is unique.

Case $k = 1$.
In this case $C_k$ is a cherry $(x, y)$.
...
\todo{No!
Two caterpillars different by the position of the cherry taxa is a counterexample.}
...
This work was partially supported by the Ministry of Business, Innovation, and Employment of New Zealand through the Endeavour Smart Ideas and Data Science Programmes grants.
