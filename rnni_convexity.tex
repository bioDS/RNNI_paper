...
The idea behind this algorithm is to efficiently return a tree as for away from a given tree as possible.
As we will see in Section~\ref{section:diameter}, $\mdtree$ achieves this exactly for caterpillar trees.
