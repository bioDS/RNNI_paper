...
More recent advances in computational phylogenetics introduce various classes of molecular clock models \autocite{Yoder2000-ks,Drummond2006-nl,Drummond2010-yf} and made possible computational inference of phylogenetic time-trees \autocite{Ronquist2003-eq, Bouckaert2018-yr, Hadfield2018-xp}.
...
\todo{I suggest to rewrite this paragraph following the standard structure:\\
\emph{Step $0$. $T_0 = T$, ...\\
Step $k+1$. $T_{k+1}$ is defined...}}
...
\todo{This term is not clear or defined.}
...
\todo{I think it is obvious.
I suggest to remove this Lemma and save it somewhere in case we get an too sensitive referee.
Tag a commit?
Or branch? -- whatever works.}
...
\todo{$p = p+T'$: Do we really want to be updating this in every while loop?}
\begin{algorithm}[H]
...
\todo{This lemma is to prove that FindPath is an (deterministic) algorithm, so we cannot relay on this.}
$p = \findpath (T,R)$.
...
\todo{I don't follow these two sentences.}
...
\todo{Are we assuming taxa is ordered?}
$x_1 < x_2$
