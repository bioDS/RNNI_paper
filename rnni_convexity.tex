...
For example, we establish convexity of certain natural subspaces in $\rnni$, which is not convex is $\nni$.
...
Furthermore, we will prove in Section~\ref{section:caterpillar_convex} that distances can be computed in polynomial time in a subspace of the $\rnni$ space.
